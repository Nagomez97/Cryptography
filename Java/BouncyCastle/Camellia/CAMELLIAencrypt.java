...
class CAMELLIAencrypt {
	...
	public static void main(String[] args){
		...
		try {
			...
			Cipher camelliaCipherForEncryption = Cipher.getInstance(transformationString, "BC");
			...
			// Step 4
			camelliaCipherForEncryption.init(Cipher.ENCRYPT_MODE, secretKey, new GCMParameterSpec(128, nonce));

			// Step 5
			byte[] encrypted = camelliaCipherForEncryption.doFinal(message.getBytes(charEnc));
