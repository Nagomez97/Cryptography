...
class TDESdecrypt {
	...
	public static final String transformationString = "DESede/CBC/PKCS5PADDING";
	public static final String encMode = "DESede";
	...
	public static void main(String[] args) {
		...
		if(args.length < 2){
			System.out.print("Usage: java TDESdecrypt [cipherdata] [secret key]\n");
			System.exit(0);
		}
