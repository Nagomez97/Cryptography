...
class BFdecrypt {
	...
	public static final String transformationString = "Blowfish/CBC/PKCS5PADDING";
	public static final String encMode = "Blowfish";
	...
	public static void main(String[] args) {
		...
		if(args.length < 2){
			System.out.print("Usage: java BFdecrypt [cipherdata] [secret key]\n");
			System.exit(0);
		}
